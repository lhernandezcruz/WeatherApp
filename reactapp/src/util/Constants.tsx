...
export const DAY_CODE_TO_ICON: IconMap = {
...
export const NIGHT_CODE_TO_ICON: IconMap = {
...
export const WARM_WEATHER_GRADIENT: Gradient = ['#20667d', '#391E94'];
export const HOT_WEATHER_MIN = 90;
export const HOT_WEATHER_GRADIENT: Gradient = ['#fb9e00', '#fe3f02'];
export const SUPER_HOT_WEATHER_MIN = 100;
export const SUPER_HOT_WEATHER_GRADIENT: Gradient = ['#bd1816 ', '#bd1816'];
